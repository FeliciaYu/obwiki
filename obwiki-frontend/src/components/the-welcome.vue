...
const getStatistic = () => {
  api.get('/ebookSnapshot/getStatistic').then((response) => {
    ...
    if (data.success) {
      ...
      //设置今天点赞数及阅读数
      statistic.value.viewCount = statisticResp.viewCount;
      statistic.value.voteCount = statisticResp.voteCount;
      statistic.value.todayViewCount = statisticResp.viewIncrease;
      statistic.value.todayVoteCount = statisticResp.voteIncrease;
      ...
      statistic.value.todayViewIncrease = parseInt(String(statisticResp.viewIncrease / nowRate));
      ...
      if (statisticResp.viewIncrease === 0) {
        ...
        statistic.value.todayViewIncreaseRate = (statistic.value.todayViewIncrease - statisticResp.viewIncrease) / statisticResp.viewIncrease * 100;
      }
      //获取绝对值显示  Math.abs
